...
**Active project path**（git 有效路徑）：

```text
~/Documents/Projects/旅遊/travel-site/
```

> Desktop 路徑 `~/Desktop/旅遊/travel-site/` 已棄用；Resume 時一律使用 Documents 路徑。
...
- 將 Drive 同步失敗改從 Desktop 或未知本機資料夾 fallback 匯入
