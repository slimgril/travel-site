...
## 景點壓縮四拍（2026-07-30 · Owner · HARD — 覆寫 07-29「知性見聞」）

> **廢止** 2026-07-29「景觀描述 — 知性見聞優先」（設計理念／建造邏輯長文）。  
> SSOT：`.ai-kos/CONTENT_STYLE.md` v1.1。主站卡片寫成**一小段散文**，不顯示 emoji／區塊標題。

| 拍 | 寫什麼 |
|----|--------|
| **① 當下** | 看見／聽見／踩到什麼 |
| **② 為什麼值得看** | 最多 1–2 個有趣事實（勿導遊詞、勿設計論文） |
| **③ 我們的旅行** | 團走、拍照、趣事（網路查不到的） |
| **④ 一句收尾** | 留下情緒 |

**比例**：景點知識約 30%，雜記與感受約 70%。篇幅宜 **3–6 句**，非長篇。  
**餐食卡**：可省略②，仍保留現場＋雜記＋收尾。  
**下一旅程**：`baikal-rail`（西伯利亞）每日每張照片同樣依本節；寫旅行書，不寫冷冰冰景點導覽。
